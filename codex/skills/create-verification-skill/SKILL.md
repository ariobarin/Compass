...
description: "Generate a project-local verification skill that drives the real app like a user. Use when a project has no scripted way to prove UI, CLI, or service behavior, or when asked to create a verification or control skill for the repo."
---
